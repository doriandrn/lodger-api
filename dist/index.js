...
var src = __webpack_require__("QWwp");
var src_default = /*#__PURE__*/__webpack_require__.n(src);

// EXTERNAL MODULE: ./node_modules/rxdb/dist/es/index.js + 114 modules
var es = __webpack_require__("p9ch");

// EXTERNAL MODULE: external "fs"
var external_fs_ = __webpack_require__("mw/K");
var external_fs_default = /*#__PURE__*/__webpack_require__.n(external_fs_);

// EXTERNAL MODULE: ./node_modules/json2yaml/index.js
var json2yaml = __webpack_require__("gkHL");
var json2yaml_default = /*#__PURE__*/__webpack_require__.n(json2yaml);
...
// EXTERNAL MODULE: ./dist/index.js
var dist = __webpack_require__("SbT1");
var dist_default = /*#__PURE__*/__webpack_require__.n(dist);

// CONCATENATED MODULE: ./src/lib/helpers/functions.ts
...
const getCriteriu = (taxonomie, criteriuCerut) => {
  ...
  const {
    defaults
  } = dist_default.a.taxonomii;
  const debug = src_default()('functions:getCriteriu');
...
const Store_debug = src_default()('lodger:Store');
const Store_modules = {};
var Errors;
...
class Store_LodgerStore extends vuex_esm["a" /* default */].Store {
  constructor(context, options = {}) {
    ...
    Store_defineProperty(this, "modules", {});
  }
  /**
   * Use a store module
...
// CONCATENATED MODULE: ./src/lib/build/opts.ts
const {
  NODE_ENV
} = process.env;
const buildOpts = {
...
const forms_debug = src_default()('lodger:forms');
/**
...
// EXTERNAL MODULE: ./node_modules/pouchdb-adapter-memory/lib/index.es.js + 2 modules
var index_es = __webpack_require__("b0B5");

// EXTERNAL MODULE: ./node_modules/pouchdb-adapter-idb/lib/index.es.js
var lib_index_es = __webpack_require__("Wh65");

// EXTERNAL MODULE: ./node_modules/pouchdb-adapter-http/lib/index.es.js
var pouchdb_adapter_http_lib_index_es = __webpack_require__("ezGW");
...
const DB_debug = src_default()('lodger:db');
const {
  NODE_ENV: DB_NODE_ENV
...
switch (DB_NODE_ENV) {
  default:
    es["c" /* plugin */](index_es["a" /* default */]);
    break;

  case 'production':
    es["c" /* plugin */](pouchdb_adapter_http_lib_index_es["a" /* default */]);
    es["c" /* plugin */](lib_index_es["a" /* default */]);
    break;
}

/* harmony default export */ var DB = (function (_x, _x2) {
  return DB_ref.apply(this, arguments);
});

function DB_ref() {
  DB_ref = _asyncToGenerator(function* (collections, config) {
    DB_debug('Initing');
    const db = yield es["a" /* create */](Object.assign({}, config)); // show leadership in title

    db.waitForLeadership().then(() => {
      if (DB_NODE_ENV !== 'dev') return;
...
// CONCATENATED MODULE: ./src/lib/Form.ts
...
class Form_Form {
  constructor(data) {
    ...
    Form_defineProperty(this, "schema", void 0);

    Form_defineProperty(this, "indexables", void 0);

    Form_defineProperty(this, "collection", void 0);
  ...
  componentData(isNewForm, getters) {
    ...
    const debug = src_default()('lodger:Form.ts:componentData');
    let $data = {};
    fields.forEach(camp => {
      const {
        label,
...
// CONCATENATED MODULE: ./src/lib/helpers/search.ts
...
// EXTERNAL MODULE: ./src/lib/forms/serviciu.ts
var serviciu = __webpack_require__("0fNj");

// CONCATENATED MODULE: ./src/index.ts
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Lodger", function() { return src_Lodger; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Errors", function() { return src_Errors; });
...
function _loadForms() {
  _loadForms = src_asyncToGenerator(function* (taxonomies) {
    return Object.assign({}, ...(yield Promise.all(taxonomies.map(
    /*#__PURE__*/
    function () {
      var _ref5 = src_asyncToGenerator(function* (tax) {
        return {
          [tax]: yield Form_Form.loadByName(tax)
        };
      });
...
function _initialSubscribe() {
  _initialSubscribe = src_asyncToGenerator(function* ({
    taxonomie,
    plural,
    collections,
    store
    ...
    switch (taxonomie) {
      ...
      case 'serviciu':
        serviciu["predefinite"].forEach(
        /*#__PURE__*/
        function () {
          var _ref6 = src_asyncToGenerator(function* (denumire) {
...
const _theDoc = (docs, id) => {
  ...
  if (!(doc && Object(es["b" /* isRxDocument */])(doc))) throw new LodgerError('no doc found %%', {
    id
  });
  return doc;
};
...
const vueHelper = new vue_runtime_esm["a" /* default */]({
  data() {
    return {
      subsData: {}
    };
  ...
  methods: {
    getItem(taxonomie, id, subscriberName) {
      ...
      return src_asyncToGenerator(function* () {
        let item;
        const debug = src_default()('lodger:getItem');
...
class src_Lodger {
  constructor(taxonomii, forms, db, store) {
    ...
    this.db = db;
    this.store = store;
    const debug = src_default()('lodger:constructor'); // const subscriberData = this.subscriberData.bind(this)
  ...
  put(taxonomy, data, subscriber) {
    ...
    return src_asyncToGenerator(function* () {
      ...
      if (!data || Object.keys(data).length < 1) throw new LodgerError(src_Errors.missingData, data);
      const {
        db,
        store,
        forms
  ...
  trash(taxonomie, id) {
    ...
    return src_asyncToGenerator(function* () {
      ...
      const debug = src_default()('lodger:trash');
      const {
        plural
      } = forms[taxonomie];
  ...
  select(taxonomie, data) {
    ...
    return src_asyncToGenerator(function* () {
      const debug = src_default()('lodger:select');
      const {
        dispatch
      } = _this4.store;
  ...
  */
  ...
  set _activeDocument(docHolder) {
    ...
    const debug = src_default()('lodger:_activeDocument');
  ...
  search(input, searchTaxonomy) {
    if (!input) return;
    const debug = src_default()('lodger:search');
  ...
  */
  ...
  subscribe(taxonomii, criteriuCerut, subscriberName = 'main') {
    ...
    const debug = src_default()('lodger:subscribe');
    const {
      db: {
        collections
      },
    ...
    if (!vueHelper.subsData[subscriberName]) {
      vue_runtime_esm["a" /* default */].set(vueHelper.subsData, subscriberName, {}); // debug('D initializat subscriber: ', subscriberName)
    }
    ...
    taxonomii.forEach(taxonomie => {
      ...
      const criteriu = Object.assign({}, src_objectSpread({}, getCriteriu(plural, JSON.parse(JSON.stringify(criteriuCerut || {}))))); // debug(`${taxonomie}: criteriu cerut`, { ...criteriuCerut })
      ...
      if (!vueHelper.subsData[subscriberName][plural]) {
        ...
        vue_runtime_esm["a" /* default */].set(vueHelper.subsData[subscriberName], plural, freshO); // debug(`setat gol D[${subscriberName}][${plural}]`, freshO)
        // add watcher for criteriu and when it changes
        // fire this subscribe func again

        if (!taxIsMultipleSelect(taxonomie)) {
          const everyKeyInCriteriu = vm => src_objectSpread({}, vm.subsData[subscriberName][plural].criteriu);

          unwatch = vueHelper.$watch(everyKeyInCriteriu, (newC, oldC) => {
            if (!newC || deep_equal_default()(newC, oldC)) return;
      ...
      /*#__PURE__*/
      function () {
        var _ref = src_asyncToGenerator(function* (changes) {
  ...
  setPreference(preference, value) {
    ...
    return src_asyncToGenerator(function* () {
      const debug = src_default()('lodger:set');
      const {
        store
      } = _this6;
      const allowedTaxonomies = ['client', 'user'];
      if (!preference) throw new LodgerError(src_Errors.invalidPreferenceIndex);
      const taxonomy = preference.split('.')[0];

      if (!taxonomy || allowedTaxonomies.indexOf(taxonomy) < 0) {
        throw new LodgerError(src_Errors.invalidPreferenceIndex);
      }
  ...
  static build(options) {
    return src_asyncToGenerator(function* () {
      ...
      const debug = src_default()('lodger:build');
      debug(`building in ${src_NODE_ENV} mode ...`);
      ...
      const store = new Store_LodgerStore({
        taxonomii,
        forms
      }); // const { collections } = await db

      if (options) Object.assign(buildOpts, src_objectSpread({}, options));
      /**
      ...
      /*#__PURE__*/
      function () {
        var _ref2 = src_asyncToGenerator(function* ({
          type,
          payload
        }, state) {
          const path = type.split('/');
          if (path[1] !== 'select') return;
          const debug = src_default()('lodger:SELECTstoreSubscriber');
          const tax = path[0];
          ...
          /*#__PURE__*/
          function () {
            var _ref3 = src_asyncToGenerator(function* (refTax) {
          ...
          if (dependentTaxonomies.length) {
            dependentTaxonomies.forEach(dTax => {
              ...
              holder.criteriu.find = src_objectSpread({}, reference); // deselect
      ...
      return new src_Lodger(taxonomii, forms, db, store);
    })();
  }
  /**
   * Extend Lodger :)
  ...
  static use(plugin) {
    const debug = src_default()('lodger:use');

    if (!plugin || typeof plugin !== 'object') {
      throw new LodgerError(src_Errors.invalidPluginDefinition);
    }
  ...
  export(path, cryptedData, filename) {
    ...
    return src_asyncToGenerator(function* () {
      const debug = src_default()('lodger:export');
      const json = yield _this8.db.dump();
      const extension = 'ldb';
      if (!path) path = `${__webpack_require__("jle/").homeDir}/downloads/`;
      ...
      external_fs_default.a.writeFile(`${path}/${filename}.${extension}`, json2yaml_default.a.stringify(json), e => {
        if (e) throw new LodgerError(src_Errors.couldNotWriteFile);
  ...
  unsubscribeAll(subscriberName = 'main') {
    return src_asyncToGenerator(function* () {
      ...
      const debug = src_default()('lodger:unsubAll');
      return yield Promise.all(Object.keys(sub).map(
      /*#__PURE__*/
      function () {
        var _ref4 = src_asyncToGenerator(function* (subscriber) {
...
const _theDoc = (docs, id) => {
  ...
  const doc = docs.filter(doc => doc._id === id)[0];
  if (!(doc && Object(rxdb__WEBPACK_IMPORTED_MODULE_1__["isRxDocument"])(doc))) throw new _lib_Errors__WEBPACK_IMPORTED_MODULE_11__[/* LodgerError */ "b"]('no doc found %%', {
    id
  });
  return doc;
};
...
/* harmony import */ var lodger_config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("SbT1");
/* harmony import */ var lodger_config__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(lodger_config__WEBPACK_IMPORTED_MODULE_0__);
...
const getTaxonomyConfig = tax => {
  const {
    taxonomii
  } = lodger_config__WEBPACK_IMPORTED_MODULE_0___default.a;
  const {
    defaults
  } = taxonomii;
  if (!tax) return defaults;
...
const getCriteriu = (taxonomie, criteriuCerut) => {
  ...
  const {
    defaults
  } = lodger_config__WEBPACK_IMPORTED_MODULE_0___default.a.taxonomii;
...
switch (NODE_ENV) {
  default:
    rxdb__WEBPACK_IMPORTED_MODULE_0__["plugin"](pouchdb_adapter_memory__WEBPACK_IMPORTED_MODULE_2__["default"]);
    break;

  case 'production':
    rxdb__WEBPACK_IMPORTED_MODULE_0__["plugin"](pouchdb_adapter_http__WEBPACK_IMPORTED_MODULE_4__["default"]);
    rxdb__WEBPACK_IMPORTED_MODULE_0__["plugin"](pouchdb_adapter_idb__WEBPACK_IMPORTED_MODULE_3__["default"]);
    break;
}
...
function _ref() {
  _ref = _asyncToGenerator(function* (collections, config) {
    debug('Initing');
    const db = yield rxdb__WEBPACK_IMPORTED_MODULE_0__["create"](Object.assign({}, config)); // show leadership in title
...
"use strict";
/* WEBPACK VAR INJECTION */(function(global, setImmediate, process) {

Object.defineProperty(exports, '__esModule', { value: true });

function _interopDefault (ex) { return (ex && (typeof ex === 'object') && 'default' in ex) ? ex['default'] : ex; }

var RxDB = __webpack_require__("p9ch");
var memoryAdapter = _interopDefault(__webpack_require__("b0B5"));
var idbAdapter = _interopDefault(__webpack_require__("Wh65"));
var httpAdapter = _interopDefault(__webpack_require__("ezGW"));
var Debug = _interopDefault(__webpack_require__("NOtv"));
...
var config$1 = {
   ...
   */
  productionTip: process$1.env.NODE_ENV !== 'production',

  /**
   * Whether to enable devtools
   */
  devtools: process$1.env.NODE_ENV !== 'production',
...
function defineReactive(obj, key, val, customSetter, shallow) {
  ...
  Object.defineProperty(obj, key, {
    ...
    set: function reactiveSetter(newVal) {
      ...
      if (process$1.env.NODE_ENV !== 'production' && customSetter) {
        customSetter();
      }
...
function set(target, key, val) {
  if (process$1.env.NODE_ENV !== 'production' && (isUndef(target) || isPrimitive(target))) {
  ...
  if (target._isVue || ob && ob.vmCount) {
    process$1.env.NODE_ENV !== 'production' && warn('Avoid adding reactive properties to a Vue instance or its root $data ' + 'at runtime - declare it upfront in the data option.');
    return val;
  }
...
function del(target, key) {
  ...
  if (target._isVue || ob && ob.vmCount) {
    process$1.env.NODE_ENV !== 'production' && warn('Avoid deleting properties on a Vue instance or its root $data ' + '- just set it to null.');
    return;
  }
...
strats.data = function (parentVal, childVal, vm) {
  if (!vm) {
    if (childVal && typeof childVal !== 'function') {
      process$1.env.NODE_ENV !== 'production' && warn('The "data" option should be a function ' + 'that returns a per-instance value in component ' + 'definitions.', vm);
      return parentVal;
    }
...
function mergeAssets(parentVal, childVal, vm, key) {
  ...
  if (childVal) {
    process$1.env.NODE_ENV !== 'production' && assertObjectType(key, childVal, vm);
...
strats.props = strats.methods = strats.inject = strats.computed = function (parentVal, childVal, vm, key) {
  if (childVal && process$1.env.NODE_ENV !== 'production') {
    assertObjectType(key, childVal, vm);
  }
...
function resolveAsset(options, type, id, warnMissing) {
  ...
  if (process$1.env.NODE_ENV !== 'production' && warnMissing && !res) {
...
function validateProp(key, propOptions, propsData, vm) {
  ...
  if (process$1.env.NODE_ENV !== 'production' && // skip validation for weex recycle-list child component props
  !(false)) {
...
function getPropDefaultValue(vm, prop, key) {
  ...
  if (process$1.env.NODE_ENV !== 'production' && isObject(def)) {
...
function updateListeners(on$$1, oldOn, add, remove$$1, vm) {
  ...
  for (name in on$$1) {
    ...
    if (isUndef(cur)) {
      process$1.env.NODE_ENV !== 'production' && warn("Invalid handler for event \"" + event.name + "\": got " + String(cur), vm);
    } else if (isUndef(old)) {
      if (isUndef(cur.fns)) {
...
function resolveAsyncComponent(factory, baseCtor, context) {
  ...
  if (isDef(factory.contexts)) {
    ...
    var reject = once$1(function (reason) {
      process$1.env.NODE_ENV !== 'production' && warn("Failed to resolve async component: " + String(factory) + (reason ? "\nReason: " + reason : ''));
    ...
    if (isObject(res)) {
      if (typeof res.then === 'function') {
        ...
        if (isDef(res.timeout)) {
          setTimeout(function () {
            if (isUndef(factory.resolved)) {
              reject(process$1.env.NODE_ENV !== 'production' ? "timeout (" + res.timeout + "ms)" : null);
            }
          }, res.timeout);
        }
      }
...
function mountComponent(vm, el, hydrating) {
  ...
  if (process$1.env.NODE_ENV !== 'production' && config$1.performance && mark) {
  ...
  new Watcher(vm, updateComponent, noop$1, null, true
  /* isRenderWatcher */
  );
...
function flushSchedulerQueue() {
  ...
  for (index = 0; index < queue$1.length; index++) {
    ...
    if (process$1.env.NODE_ENV !== 'production' && has[id] != null) {
...
var Watcher = function Watcher(vm, expOrFn, cb, options, isRenderWatcher) {
  ...
  this.expression = process$1.env.NODE_ENV !== 'production' ? expOrFn.toString() : ''; // parse expression for getter
  ...
  if (typeof expOrFn === 'function') {
    ...
    if (!this.getter) {
      ...
      process$1.env.NODE_ENV !== 'production' && warn("Failed watching path: \"" + expOrFn + "\" " + 'Watcher only accepts simple dot-delimited paths. ' + 'For full control, use a function instead.', vm);
    }
  }
...
function initData(vm) {
  ...
  if (!isPlainObject(data)) {
    data = {};
    process$1.env.NODE_ENV !== 'production' && warn('data functions should return an object:\n' + 'https://vuejs.org/v2/guide/components.html#data-Must-Be-a-Function', vm);
  ...
  while (i--) {
    ...
    if (props && hasOwn(props, key)) {
      process$1.env.NODE_ENV !== 'production' && warn("The data property \"" + key + "\" is already declared as a prop. " + "Use prop default value instead.", vm);
...
function initComputed(vm, computed) {
  ...
  for (var key in computed) {
    ...
    if (process$1.env.NODE_ENV !== 'production' && getter == null) {
...
function defineComputed(target, key, userDef) {
  ...
  if (typeof userDef === 'function') {
    ...
    sharedPropertyDefinition.get = userDef.get ? shouldCache && userDef.cache !== false ? createComputedGetter(key) : userDef.get : noop$1;
    sharedPropertyDefinition.set = userDef.set ? userDef.set : noop$1;
  }

  if (process$1.env.NODE_ENV !== 'production' && sharedPropertyDefinition.set === noop$1) {
...
function renderSlot(name, fallback, props, bindObject) {
  ...
  if (scopedSlotFn) {
    ...
    if (bindObject) {
      if (process$1.env.NODE_ENV !== 'production' && !isObject(bindObject)) {
    ...
    if (slotNodes) {
      if (process$1.env.NODE_ENV !== 'production' && slotNodes._rendered) {
...
function bindObjectProps(data, tag, value, asProp, isSync) {
  if (value) {
    if (!isObject(value)) {
      process$1.env.NODE_ENV !== 'production' && warn('v-bind without argument expects an Object or Array value', this);
    } else {
      if (Array.isArray(value)) {
...
function bindObjectListeners(data, value) {
  if (value) {
    if (!isPlainObject(value)) {
      process$1.env.NODE_ENV !== 'production' && warn('v-on without argument expects an Object value', this);
    } else {
...
function _createElement(context, tag, data, children, normalizationType) {
  if (isDef(data) && isDef(data.__ob__)) {
    process$1.env.NODE_ENV !== 'production' && warn("Avoid using observed data object as vnode data: " + JSON.stringify(data) + "\n" + 'Always create fresh vnode data objects in each render!', context);
  ...
  if (process$1.env.NODE_ENV !== 'production' && isDef(data) && isDef(data.key) && !isPrimitive(data.key)) {
    {
...
function renderMixin(Vue) {
  ...
  Vue.prototype._render = function () {
    ...
    if (!(vnode instanceof VNode)) {
      if (process$1.env.NODE_ENV !== 'production' && Array.isArray(vnode)) {
...
function Vue(options) {
  if (process$1.env.NODE_ENV !== 'production' && !(this instanceof Vue)) {
...
function initExtend(Vue) {
  ...
  Vue.extend = function (extendOptions) {
    ...
    if (process$1.env.NODE_ENV !== 'production' && name) {
  ...
  ASSET_TYPES.forEach(function (type) {
    Vue[type] = function (id, definition) {
      if (!definition) {
        ...
        /* istanbul ignore if */
        if (process$1.env.NODE_ENV !== 'production' && type === 'component') {
...
function query(el) {
  if (typeof el === 'string') {
    ...
    if (!selected) {
      process$1.env.NODE_ENV !== 'production' && warn('Cannot find element: ' + el);
...
function createPatchFunction(backend) {
  ...
  function createElm(vnode, insertedVnodeQueue, parentElm, refElm, nested, ownerArray, index) {
    ...
    if (isDef(tag)) {
      ...
      if (process$1.env.NODE_ENV !== 'production' && data && data.pre) {
        creatingElmInVPre--;
      }
      ...
      if (isDef(children)) {
        ...
        if (!elm.hasChildNodes()) {
          ...
          if (isDef(i = data) && isDef(i = i.domProps) && isDef(i = i.innerHTML)) {
            if (i !== elm.innerHTML) {
              /* istanbul ignore if */
              if (process$1.env.NODE_ENV !== 'production' && typeof console !== 'undefined' && !hydrationBailed) {
...
function enter(vnode, toggleDisplay) {
  ...
  if (process$1.env.NODE_ENV !== 'production' && explicitEnterDuration != null) {
...
function leave(vnode, rm) {
  ...
  if (process$1.env.NODE_ENV !== 'production' && isDef(explicitLeaveDuration)) {
...
function actuallySetSelected(el, binding$$1, vm) {
  ...
  if (isMultiple && !Array.isArray(value)) {
    process$1.env.NODE_ENV !== 'production' && warn("<select multiple v-model=\"" + binding$$1.expression + "\"> " + "expects an Array value for its binding, but got " + Object.prototype.toString.call(value).slice(8, -1), vm);
    return;
  }
...
var Transition = {
  ...
  render: function render(h) {
    ...
    if (process$1.env.NODE_ENV !== 'production' && children.length > 1) {
      warn('<transition> can only be used on a single element. Use ' + '<transition-group> for lists.', this.$parent);
    }

    var mode = this.mode; // warn invalid mode

    if (process$1.env.NODE_ENV !== 'production' && mode && mode !== 'in-out' && mode !== 'out-in') {
...
if (inBrowser) {
  setTimeout(function () {
    if (config$1.devtools) {
      ...
      } else if (process$1.env.NODE_ENV !== 'production' && process$1.env.NODE_ENV !== 'test' && isChrome) {
        console[console.info ? 'info' : 'log']('Download the Vue Devtools extension for a better development experience:\n' + 'https://github.com/vuejs/vue-devtools');
      }
    }

    if (process$1.env.NODE_ENV !== 'production' && process$1.env.NODE_ENV !== 'test' && config$1.productionTip !== false && typeof console !== 'undefined') {
...
var Store = function Store(options) {
  ...
  this._subscribers = [];
  this._watcherVM = new Vue$1(); // bind commit and dispatch to self
...
const version$1 = __webpack_require__("kiQV").version;
const taxonomii = {
    defaults: {
        criteriu: {
            limit: 25,
...
const getCriteriu = (taxonomie, criteriuCerut) => {
    ...
    const { defaults } = config$2.taxonomii;
    const debug = Debug('functions:getCriteriu');
    const criteriu = Object.assign({}, Object.assign({}, defaults.criteriu), Object.assign({}, getTaxonomyConfig(taxonomie).criteriu), Object.assign({}, criteriuCerut));
...
const { version: version$2 } = config$2;
const state$2 = {
    locale: 'ro',
    version: version$2
};
...
const customOpts = (context, options) => {
    ...
    taxonomii.forEach((tax) => {
        ...
        modules$2[tax] = setupSharedMethods(undefined, undefined, tax, plural);
    });
    if (RootModule && modules$1) {
        // LodgerStore.use(RootModule, false)
        Object.assign(options, RootModule);
        Object.keys(modules$1).forEach(module => {
            LodgerStore.use({ [module]: modules$1[module] }, module !== 'toast');
        });
    }
    options.modules = modules$2;
    return options;
};
// export default class LodgerStore implements StoreOptions<RootState> {
class LodgerStore extends index_esm.Store {
    constructor(context, options = {}) {
        super(customOpts(context, options));
        this.context = context;
        this.options = options;
    ...
    static use(module, namespaced = true) {
        ...
        if (!key || !module[key])
            throw new LodgerError(Errors.invalidModule);
        debug('using module', key);
        modules$2[key] = Object.assign({}, module[key], { namespaced });
    }
}
...
const toSchemaField = (formItem) => {
    ...
    // })
    if (index)
        Object.assign(field, { index });
    if (step)
        Object.assign(field, { multipleOf: step });
    if (ref)
        Object.assign(field, ref);
    return { [id]: field };
};
/**
 * Adauga un camp la schema Rx
...
const pushFieldToSchema = (formItem, schema) => {
    ...
    if (formItem.required && required && required.indexOf(id) < 0)
...
const { NODE_ENV: NODE_ENV$1 } = process.env;
...
function DB (collections, config) {
    return __awaiter(this, void 0, void 0, function* () {
        debug$2('Initing');
        const db = yield RxDB.create(Object.assign({}, config));
 ...
 */
function toRxCollection(context) {
    const { schema, data: { plural, methods, statics } } = context;
    const name = plural;
...
class Form {
    ...
    static loadByName(name) {
        ...
        let form;
        return Promise.resolve(__webpack_require__("eiOh")(`./${name}`)).then(formData => {
...
/// <reference path="main.d.ts" />
const { NODE_ENV: NODE_ENV$2 } = process.env;
const subscribers = {
    main: {},
    registru: {},
    listeDePlata: {},
...
function loadForms(taxonomies) {
    return __awaiter(this, void 0, void 0, function* () {
        return Object.assign({}, ...yield Promise.all(taxonomies.map((tax) => __awaiter(this, void 0, void 0, function* () {
            return { [tax]: yield Form.loadByName(tax) };
        }))));
    });
}
const plugins = [];
...
const subscribedTaxes = [];
function initialSubscribe({ taxonomie, plural: plural$$1, collections, store }) {
    return __awaiter(this, void 0, void 0, function* () {
        // const debug = Debug('lodger:initialSubscribe')
        switch (taxonomie) {
            // insert predefined services
            case 'serviciu':
                predefinite.forEach((denumire) => __awaiter(this, void 0, void 0, function* () { yield collections[plural$$1].insert({ denumire }); }));
                break;
            // insert admin user
            case 'utilizator':
                const { _id } = yield collections[plural$$1].insert({
                    name: 'Administrator',
                    rol: 'admin'
                });
                store.dispatch('utilizator/set_active', _id);
...
const _theDoc = (docs, id) => {
    ...
    const doc = docs.filter(doc => doc._id === id)[0];
    if (!(doc && RxDB.isRxDocument(doc)))
        throw new LodgerError('no doc found %%', { id });
    return doc;
};
/**
 * Main holder for temporary items subscribed to
...
class Lodger {
    constructor(taxonomii, forms, db, store) {
        ...
        taxonomii.forEach(tax => {
            const { plural: plural$$1 } = forms[tax];
                ...
                get() {
                    ...
                    return (subscriberName = 'main') => {
                        try {
                            ...
                            throw new LodgerError('not yet defined. wait more! :) %%', { subscriberName, plural: plural$$1 });
                        }
                    };
                }
            });
    ...
    put(taxonomy, data, subscriber) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!data || Object.keys(data).length < 1)
                throw new LodgerError(exports.Errors.missingData, data);
            const { db, store, forms } = this;
            const { plural: plural$$1 } = forms[taxonomy];
    ...
    trash(taxonomie, id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { plural: plural$$1 } = forms[taxonomie];
            if (!plural$$1)
                throw new LodgerError('wtf');
    ...
    select(taxonomie, data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!form)
                throw new LodgerError('invalid taxonomy %%', taxonomie);
            const isObj = typeof data === 'object' && data !== null;
            const id = isObj && data.id ? data.id : data;
            const subscriber = isObj && data.subscriber ? data.subscriber : undefined;
            yield dispatch(`${taxonomie}/select`, id);
            // // deselect
            // if (!id) {
            //   await dispatch(`${taxonomie}/select`, undefined)
            //   return
    ...
    */
    subscribe(taxonomii, criteriuCerut, subscriberName = 'main') {
        ...
        taxonomii.forEach(taxonomie => {
            ...
            if (!colectie)
                throw new LodgerError('invalid collection %%', plural$$1);
            const criteriu = Object.assign({}, Object.assign({}, getCriteriu(plural$$1, JSON.parse(JSON.stringify(criteriuCerut || {})))));
            // debug(`${taxonomie}: criteriu cerut`, { ...criteriuCerut })
            // debug(`${taxonomie}: criteriu`, criteriu)
            ...
            let unwatch;
            if (subscribedTaxes.indexOf(taxonomie) < 0) {
                initialSubscribe({ taxonomie, plural: plural$$1, collections, store });
            }
            // Define the data object container
            if (!vueHelper.subsData[subscriberName][plural$$1]) {
                const freshO = Object.assign({}, vueHelperObj);
                freshO.criteriu = Object.assign({}, criteriu);
                Vue.set(vueHelper.subsData[subscriberName], plural$$1, freshO);
                ...
                // vueHelper[subscriberName][plural].criteriu = criteriu
                vueHelper.subsData[subscriberName][plural$$1].fetching = true;
                // this.unsubscribe(plural, subscriberName) // todo: update ot new sub model
            }
            if (typeof unwatch === 'function')
                vueHelper.subsData[subscriberName][plural$$1].unwatch = unwatch;
            subscriber[plural$$1] = colectie
                .find(find)
                .limit(paging)
                .sort(sort)
                .$
                .subscribe((changes) => __awaiter(this, void 0, void 0, function* () {
                // DO NOT RETURN IF NO CHANGES!!!!!!!
                // debug(`${plural} for subscriber[${subscriberName}]`, changes)
    ...
    static build(options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            // const { collections } = await db
            if (options)
                Object.assign(buildOpts, Object.assign({}, options));
            /**
             * When a taxonomy item gets SELECTED,
             * try to call all DB methods for refrences of the taxonomy
             *
             */
            store.subscribe(({ type, payload }, state) => __awaiter(this, void 0, void 0, function* () {
                const path = type.split('/');
                if (path[1] !== 'select')
                    return;
                ...
                if (dependentTaxonomies.length) {
                    dependentTaxonomies.forEach(dTax => {
                        const subscriber = payload.subscriber || 'main';
                        const { plural: plural$$1 } = forms[dTax];
                        const holder = vueHelper.subsData[subscriber][plural$$1];
                        if (!holder || !holder.criteriu)
                            return;
                        debug('asignez', dTax, subscriber, reference);
                        holder.criteriu.find = Object.assign({}, reference);
                        // deselect
    ...
    export(path, cryptedData, filename) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const extension = 'ldb';
            if (!path)
                path = `${__webpack_require__("PENG").homeDir}/downloads/`;
            if (!filename) {
                const date = new Date();
                filename = `LdgDB-${date}`;
            }
            fs.writeFile(`${path}/${filename}.${extension}`, json2yaml.stringify(json), (e) => {
                if (e)
                    throw new LodgerError(exports.Errors.couldNotWriteFile);
                debug(`written ${filename}.${extension} in path`);
            });
        });
    }
    ...
    get subscriberData() {
        ...
        return (taxonomy, subscriberName) => {
            ...
            try {
                ...
                throw new LodgerError('nu exista %%', { plural: plural$$1, subscriberName });
            }
        };
    }
}
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__("yLpj"), __webpack_require__("URgk").setImmediate, __webpack_require__("8oxB")))
