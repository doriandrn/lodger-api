...
describe('Form', () => {
    ...
    describe('.load() - Loads a form by name', () => {
        ...
        beforeAll(() => __awaiter(this, void 0, void 0, function* () {
            try {
                form = yield Form.load(formToLoadAndTest);
            }
            catch (e) {
                console.error('wtf', e);
            }
        ...
        describe('negative', () => {
            test('throws if called with anything else than string', () => __awaiter(this, void 0, void 0, function* () {
                try {
                    yield Form.load('');
                }
                catch (e) {
            ...
            test('throws for unknown filenames', () => __awaiter(this, void 0, void 0, function* () {
                try {
                    yield Form.load('ceva');
                }
                catch (e) {
                    expect(e).toBeDefined();
                }
